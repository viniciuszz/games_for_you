...
<head>
    ...
    <title>Pagina nintendo</title>
</head>

<body>

    <!--Inicio do cabeçalho do site/menu -->
    <header id="header-nintendo" class="gradient col-lg-12 col-md-12 col-sm-12">
        ...
        <div class="barra-pesquisa col-lg-9 col-md-9 col-sm-9">
            <form method="get" action="pesquisa.php">
                <span class="icon-search-n material-symbols-outlined">
                    search
                </span>
        ...
        <nav id="nav" class="col-lg-9 col-md-9 col-sm-9">
            ...
            <ul id="menu" role="menu">
                <li><a id="a-nintendo" href="index.php">Home</a></li>
                <li><a id="a-nintendo" href="pagxbox.php">Xbox</a></li>
                <li><a id="a-nintendo" href="pagplaystation.php">Playstation</a></li>
                <li><a id="a-nintendo" class="borda-nintendo" href="pagnintendo.php">Nintendo</a></li>
            </ul>
        </nav>
        </div>
        ...
        <div class="cxlogin col-sm-4 col-md-2 col-lg-1">
            ...
            ?>
                <a href="cadastro_login.php">
                    <button type="image" class="btn"><span class="material-symbols-outlined login-nintendo">
                            account_circle
                        </span></button>
                </a>
            <?php
    ...
    <div class="nav-header">
        <nav id="nav" class="shadow-n col-lg-9 col-md-9 col-sm-9">
            <button aria-label="Abrir Menu" id="btn-mobile" aria-haspopup="true" aria-controls="menu" aria-expanded="false">
                <span id="hamburger"></span>
            </button>
            <ul id="menu" role="menu">
    ...
    <?php
        ...
        //mostra todos os valores da pagina nintendo
    ...
    <footer>
        <section class="footer col-lg-12 col-md-12 col-sm-12">
            ...
            <ul class="list col-lg-6 col-md-6 col-sm-12">
                <li class="listra">
                    <a class="footer-nintendo" href="index.php">Home</a>
                </li>
                <li class="listra">
                    <a class="footer-nintendo" href="pagxbox.php">Xbox</a>
                </li>
                <li class="listra">
                    <a class="footer-nintendo" href="pagplaystation.php">Playstation</a>
                </li>
                <li>
                    <a class="footer-nintendo" href="pagnintendo.php">Nintendo</a>
                </li>
            </ul>
