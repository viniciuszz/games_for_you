...
<head>
    ...
    <title>Pagina xbox</title>
</head>

<body>

    <!--Inicio do cabeçalho do site/menu -->
    <header id="header-xbox" class="gradient col-lg-12 col-md-12 col-sm-12">
        ...
        <div class="barra-pesquisa col-lg-9 col-md-9 col-sm-9">
            <form method="get" action="pesquisa.php">
                <span class="icon-search-x material-symbols-outlined">
                    search
                </span>
        ...
        <nav id="nav" class="col-lg-9 col-md-9 col-sm-9">
            ...
            <ul id="menu" role="menu">
                <li><a id="a-xbox" href="index.php">Home</a></li>
                <li><a id="a-xbox" href="pagxbox.php">Xbox</a></li>
                <li><a id="a-xbox" href="pagplaystation.php">Playstation</a></li>
                <li><a id="a-xbox" class="borda-nintendo" href="pagnintendo.php">Nintendo</a></li>
            </ul>
        </nav>
        </div>
        ...
        <div class="cxlogin col-sm-4 col-md-2 col-lg-1">
            ...
            ?>
                <a href="cadastro_login.php">
                    <button type="image" class="btn"><span class="material-symbols-outlined login-xbox">
                            account_circle
                        </span></button>
                </a>
            <?php
    ...
    <footer>
        <section class="footer col-lg-12 col-md-12 col-sm-12">
            ...
            <ul class="list col-lg-6 col-md-6 col-sm-12">
                <li class="listra">
                    <a class="footer-xbox" href="index.php">Home</a>
                </li>
                <li class="listra">
                    <a class="footer-xbox" href="pagxbox.php">Xbox</a>
                </li>
                <li class="listra">
                    <a class="footer-xbox" href="pagplaystation.php">Playstation</a>
                </li>
                <li>
                    <a class="footer-xbox" href="pagnintendo.php">Nintendo</a>
                </li>
            </ul>
